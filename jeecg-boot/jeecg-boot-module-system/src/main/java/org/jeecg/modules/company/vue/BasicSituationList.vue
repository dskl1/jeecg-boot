  ...
  export default {
    ...
    methods: {
      ...
      onSelectChange (selectedRowKeys, selectionRows) {
        ...
        this.$refs.BasicSituationList.getMain(this.selectedRowKeys[0])
      },
      searchQuery: function () {
        this.selectedRowKeys = []
        this.selectionRows = []
        this.$refs.BasicSituationList.queryParam.mainId = null
        this.$refs.BasicSituationList.loadData()
        this.$refs.BasicSituationList.selectedRowKeys = []
        this.$refs.BasicSituationList.selectionRows = []
        this.loadData()
      },
      initDictConfig () {
      }
