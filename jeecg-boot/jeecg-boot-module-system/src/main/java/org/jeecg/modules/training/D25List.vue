<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('25')">导出</a-button>
      <a-upload
        name="file"
    ...
    <d25-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></d25-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: '/training/trainingScore/listD25ByMainId',
          delete: '/training/trainingScore/deleteD25',
          deleteBatch: '/training/trainingScore/deleteBatchD25',
          exportXlsUrl: '/training/trainingScore/exportD25',
          importUrl: '/training/trainingScore/importD25',
        },
        dictOptions: {},
        selectedMainId:''
      }
