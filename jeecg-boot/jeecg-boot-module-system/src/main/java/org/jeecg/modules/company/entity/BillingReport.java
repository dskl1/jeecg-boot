...
//    @Excel(name = "岗位", width = 15)
     ...
     * 入场时间
     */
//	@Excel(name = "入场时间", width = 20, format = "yyyy-MM-dd")
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
     ...
     * 离场时间
     */
//	@Excel(name = "离场时间", width = 20, format = "yyyy-MM-dd")
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
...
//    @Excel(name = "客户方", width = 15)
     ...
     * 开票金额
     */
    @Excel(name = "开票金额", width = 15, isStatistics = true)
    private java.math.BigDecimal billingPrice;
    /**
     * 回款日期
     */
    @Excel(name = "回款日期", width = 20, format = "yyyy-MM-dd")
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
     ...
     * 开票日期(分包公司)
     */
    @Excel(name = "开票日期(分包公司)", width = 20, format = "yyyy-MM-dd")
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
     ...
     * 回款日期(分包公司)
     */
    @Excel(name = "回款日期(分包公司)", width = 20, format = "yyyy-MM-dd")
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
