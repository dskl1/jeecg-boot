<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <BillingReport-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/company/employee/listBillingReportByMainId",
          delete: "/company/employee/deleteBillingReport",
          deleteBatch: "/company/employee/deleteBatchBillingReport",
        }
      }
    },
    methods: {
      loadData(arg) {
        ...
        getAction(this.url.list, {    sportsmanId                      : params.mainId
