<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('training_score')">导出</a-button>
    ...
    <a-tabs defaultActiveKey="1">
      ...
      <a-tab-pane tab="150" key="3" forceRender>
        <D150List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="200" key="4" forceRender>
        <D200List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="250" key="5" forceRender>
        <D250List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="300" key="6" forceRender>
        <D300List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="350" key="7" forceRender>
        <D350List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="400" key="8" forceRender>
        <D400List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="800" key="9" forceRender>
        <D800List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="1000" key="10" forceRender>
        <D1000List :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="1500" key="11" forceRender>
