<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <D50a-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
    ...
    data() {
      return {
        ...
        url: {
          ...
          delete: "/statistics/statistics/deleteD50a",
          deleteBatch: "/statistics/statistics/deleteBatchD50a",
        }
      }
    },
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加50";
      },
    }
  }
</script>
