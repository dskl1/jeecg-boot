 ...
 */
@Data
@TableName("salary_statistics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "salary_statistics对象", description = "工资统计")
public class SalaryStatistics implements Serializable {
     ...
     * 应发(整数)
     */
    @Excel(name = "应发(整数)", width = 10, isStatistics = true)
    @ApiModelProperty(value = "应发(整数)")
    ...
    public BigDecimal getDispatchSubsidyStandard() {
        return dispatchSubsidyStandard;
    }

    public Double getPositiveDay() {
        return positiveDay;
    }

    public Double getTrialDay() {
        return trialDay;
    }
    ...
    public BigDecimal getDispatchSubsidy() {
        return dispatchSubsidy;
    }

    public BigDecimal getYearHoliday() {
        return yearHoliday;
    }
    ...
    public BigDecimal getOtherThing() {
        return otherThing;
    }
    ...
    public BigDecimal getSocialSecurityPerson() {
        return socialSecurityPerson;
    }
    ...
    public BigDecimal getSocialSecurityCo() {
        return socialSecurityCo;
    }
    ...
    public String getSpecialDeductionItems() {
        return specialDeductionItems;
    }

    public BigDecimal getSpecialDeductionAmount() {
    ...
    public Double getPositiveDispatchDay() {
        return positiveDispatchDay;
    }

    public Double getTrialDispatchDay() {
        return trialDispatchDay;
    }

    public Double getTrialDiscount() {
        return trialDiscount;
    }

    public Double getAbsenceDiscount() {
