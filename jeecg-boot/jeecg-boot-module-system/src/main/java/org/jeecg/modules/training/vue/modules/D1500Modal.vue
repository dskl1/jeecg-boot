    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="训练日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择训练日期" v-decorator="['trainingDate']" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="时间段" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['period']" placeholder="请输入时间段"></a-input>
        </a-form-item>
        <a-form-item label="训练小组" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['trainingGroupId']" placeholder="请输入训练小组"></a-input>
        </a-form-item>
        <a-form-item label="训练序号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['trainingItemNo']" placeholder="请输入训练序号"></a-input>
        </a-form-item>
        <a-form-item label="训练项目" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['trainingItem']" placeholder="请输入训练项目"></a-input>
        </a-form-item>
        <a-form-item label="组数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['groupNo']" placeholder="请输入组数" style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="是否高原" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['isHighland']" placeholder="请输入是否高原"></a-input>
        </a-form-item>
        <a-form-item label="包干时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['baoGan']" placeholder="请输入包干时间" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="趟数" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['tangShu']" placeholder="请输入趟数" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="辅助道具" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['supportItem']" placeholder="请输入辅助道具"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/training/trainingScore/addD1500",
          edit: "/training/trainingScore/editD1500",
        }
