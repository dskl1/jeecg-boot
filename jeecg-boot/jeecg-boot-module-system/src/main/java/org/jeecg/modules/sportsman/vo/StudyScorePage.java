 ...
 */
@Data
@ApiModel(value = "sportsman_registration_entryPage对象", description = "学习成绩")
public class StudyScorePage {
...
//    @Excel(name = "运动员id", width = 15)
     ...
     * 系统时间
     */
    @Excel(name = "系统时间", width = 15, format = "yyyy-MM-dd")
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
