      ...
      scale: [{
      ...
      },
        {
          ...
          formatter: function formatter(val) {
            // return parseInt(val / 10000) + ':' + parseInt(val / 1000 % 10) + parseInt(val / 100 % 10) + ':' + parseInt(val / 10 % 10) + parseInt(val % 10)
            return String(parseInt(val / 1000 % 10)) + parseInt(val / 100 % 10) + ':' + parseInt(val / 10 % 10) + parseInt(val % 10)
          }
        }],
