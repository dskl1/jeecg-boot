...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {},
      url: {
        // add: "/company/newestEmployee/add",
        // edit: "/company/newestEmployee/edit",
        add: '/company/employee/add',
        edit: '/company/employee/edit',
        newestBillingReportList: '/company/newestEmployee/queryNewestBillingReportByMainId',
      }
    }
  },
  methods: {
