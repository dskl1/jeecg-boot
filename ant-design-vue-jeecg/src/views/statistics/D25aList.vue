<template>
  <a-card :bordered="false">
    <div class="page-header-index-wide">
      ...
      <a-row>
        <a-col :span="24">
          <a-card :loading="loading" activeTabKey="id" :bordered="false" title="训练成绩报表"
            ...
            <line-chart-multid :fields="trainingFields" :dataSource="trainingInfo25"></line-chart-multid>
          </a-card>
        </a-col>
      </a-row>
    </div>
...
export default {
  ...
  data() {
    return {
      columns: [],
      url: {
        list: '/statistics/statistics/listD25aByMainId',
        chart: '/statistics/statistics/trainingInfo25',
        delete: '/statistics/statistics/deleteD25a',
        deleteBatch: '/statistics/statistics/deleteBatchD25a',
      },
      loading: true,
      center: null,
      barData: [],
      loginfo: {},
      timeSelectOption: '7',
      trainingFields: ['25米仰泳', '25米自由泳', '25米蝶泳', '25米蛙泳', '25米自测'],
      trainingInfo25: [],
    ...
    onChange(selectedValue) {
      ...
      if (params.mainId != null) {
        getAction(this.url.chart, { mainId: params.mainId, selectValue: selectedValue }).then((res) => {
          if (res.success) {
            this.trainingInfo25 = res.result
          } else {
            this.trainingInfo25 = null
          }
        })
      }
    },
