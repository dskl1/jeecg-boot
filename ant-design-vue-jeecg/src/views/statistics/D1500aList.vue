      ...
      <a-row>
        <a-col :span="24">
          <a-card :loading="loading" activeTabKey="id" :bordered="false" title="训练成绩报表" :style="{ marginLeft:'10px',marginTop: '24px' }">
            ...
            <line-chart-multid :fields="trainingFields" :dataSource="trainingInfo1500"></line-chart-multid>
          </a-card>
        </a-col>
      </a-row>
    </div>
    ...
    export default {
        ...
        data() {
            return {
                columns: [],
                url: {
                    list: "/statistics/statistics/listD1500aByMainId",
                    chart:"/statistics/statistics/trainingInfo1500",
                    delete: "/statistics/statistics/deleteD1500a",
                    deleteBatch: "/statistics/statistics/deleteBatchD1500a",
                },
                loading: true,
                center: null,
                barData:[],
                loginfo:{},
                timeSelectOption:"7",
                trainingFields:['1500米仰泳','1500米自由泳','1500米蝶泳','1500米蛙泳','1500米自测'],
                trainingInfo1500:[],
            ...
            onChange (selectedValue) {
                ...
                if(params.mainId!=null) {
                    getAction(this.url.chart, {mainId: params.mainId, selectValue: selectedValue}).then((res) => {
                        if (res.success) {
                            this.trainingInfo1500 = res.result;
                        } else {
                            this.trainingInfo1500 = null;
                        }
                    })
                }
            },
