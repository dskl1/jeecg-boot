      ...
      <a-row>
        <a-col :span="24">
          <a-card :loading="loading" activeTabKey="id" :bordered="false" title="训练成绩报表" :style="{ marginLeft:'10px',marginTop: '24px' }">
            ...
            <line-chart-multid :fields="trainingFields" :dataSource="trainingInfo200"></line-chart-multid>
          </a-card>
        </a-col>
      </a-row>
    </div>
    ...
    export default {
        ...
        data() {
            return {
                columns: [],
                url: {
                    list: "/statistics/statistics/listD200aByMainId",
                    chart:"/statistics/statistics/trainingInfo200",
                    delete: "/statistics/statistics/deleteD200a",
                    deleteBatch: "/statistics/statistics/deleteBatchD200a",
                },
                loading: true,
                center: null,
                barData:[],
                loginfo:{},
                timeSelectOption:"7",
                trainingFields:['200米仰泳','200米自由泳','200米蝶泳','200米蛙泳','200米自测'],
                trainingInfo200:[],
            ...
            onChange (selectedValue) {
                ...
                if(params.mainId!=null) {
                    getAction(this.url.chart, {mainId: params.mainId, selectValue: selectedValue}).then((res) => {
                        if (res.success) {
                            this.trainingInfo200 = res.result;
                        } else {
                            this.trainingInfo200 = null;
                        }
                    })
                }
            },
