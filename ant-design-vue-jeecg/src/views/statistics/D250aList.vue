      ...
      <a-row>
        <a-col :span="24">
          <a-card :loading="loading" activeTabKey="id" :bordered="false" title="训练成绩报表" :style="{ marginLeft:'10px',marginTop: '24px' }">
            ...
            <line-chart-multid :fields="trainingFields" :dataSource="trainingInfo250"></line-chart-multid>
          </a-card>
        </a-col>
      </a-row>
    </div>
    ...
    export default {
        ...
        data() {
            return {
                columns: [],
                url: {
                    list: "/statistics/statistics/listD250aByMainId",
                    chart:"/statistics/statistics/trainingInfo250",
                    delete: "/statistics/statistics/deleteD250a",
                    deleteBatch: "/statistics/statistics/deleteBatchD250a",
                },
                loading: true,
                center: null,
                barData:[],
                loginfo:{},
                timeSelectOption:"7",
                trainingFields:['250米仰泳','250米自由泳','250米蝶泳','250米蛙泳','250米自测'],
                trainingInfo250:[],
            ...
            onChange (selectedValue) {
                ...
                if(params.mainId!=null) {
                    getAction(this.url.chart, {mainId: params.mainId, selectValue: selectedValue}).then((res) => {
                        if (res.success) {
                            this.trainingInfo250 = res.result;
                        } else {
                            this.trainingInfo250 = null;
                        }
                    })
                }
            },
